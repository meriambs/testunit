...
//naw we will describe our test :
//dont forget to close all your ports to run the test !!!!

describe("task API",()=>{

    //testthe get all task 
            ...
            it("It should POST a new task", (done) => {
                ...
                chai.request(server)                
                    ...
                    .end((err, response) => {
                        ...
                        response.body.should.have.property('name').eq("Task4");
        ...
        it("It should POST a new task", (done) => {
            ...
            chai.request(server)                
                ...
                .end((err, response) => {
                    ...
                    response.body.should.be.a('object');
                    response.body.should.have.property('id').eq(1);
                    response.body.should.have.property('name').eq("Task1 changed");
